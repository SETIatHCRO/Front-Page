...
file=pd.read_csv(ant+'/Y-pol/YC1.csv', sep=',')
file2=pd.read_csv(ant+'/Y-pol/YH1.csv', sep=',')
print file.columns #writes the simulated values in columns
freq_0= file['Freq'].values/1e9
cold_Y_db = file['Trace1'].values
hot_Y_db = file2['Trace1'].values
