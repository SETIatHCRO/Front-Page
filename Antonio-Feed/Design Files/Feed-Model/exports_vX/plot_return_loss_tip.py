...
#plt.plot(freq, S11_e, linewidth=1.5,label='Return Loss Coax existing')
plt.plot(freq, S22_e, linewidth=1.5,label='Return Loss Tip existing')

#plt.plot(freq, S11_1, linewidth=1.5,label='Return Loss Coax Vers.1')
plt.plot(freq, S22_1, linewidth=1.5,label='Return Loss Tip Vers.1')

#plt.plot(freq, S11_2, linewidth=1.5,label='Return Loss Coax Vers.2')
plt.plot(freq, S22_2, linewidth=1.5,label='Return Loss Tip Vers.2')

plt.plot(freq, S22_2_1, linewidth=1.5,label='Return Loss Tip Vers.2.1')
...
plt.savefig('Tip_design_return_loss.pdf', bbox_inches="tight")
