...
file2=pd.read_csv('V3_rogers3006.csv', sep=',')
...
plt.plot(freq_e, S11_e, linewidth=1.5,label='Return Loss existing')
plt.plot(freq_e, S21_e, linewidth=1.5,label='Insertion Loss existing')

plt.plot(freq_1, S11_1, linewidth=1.5,label='Return Loss Coax V.3')
plt.plot(freq_1, S21_1, linewidth=1.5,label='Insertion Loss V.3')

plt.plot(freq_2, S11_2, linewidth=1.5,label='Return Loss Coax V.3 Rogers 3006')
