...
file=pd.read_csv('ATA_Cap_V1__FEED_Tip_existing.csv', sep=',')
...
file1=pd.read_csv('ATA_Cap_V1__FEED_Tip_fab_Cap_Board_V2_(changed_dielectric).csv', sep=',')
...
plt.plot(freq, S11_1, linewidth=1.5,label='Return Loss R02 link with modified cap.')
plt.plot(freq, S21_1, linewidth=1.5,label='Insertion Loss R02 link with modified cap.')
...
plt.savefig('comparison_capacitor_board.pdf', bbox_inches="tight")
